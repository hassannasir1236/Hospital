        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="../build/assets/img/bg-doctor.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <form class="main-form" method="post" action="appointment" >
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
            <input type="date" name="appointment_time" class="form-control" value="{{old('appointment_time')}}" required >
            @if ($errors->has('appointment_time'))
              <span class="" style="color: red;">
                  <strong class="text-red-500" style="color: red;">{{ $errors->first('appointment_time') }}</strong>
              </span>
             @endif
          </div>
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="speciality" id="departement" class="custom-select" value="{{old('speciality')}}" required>
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <input type="number" name="user_phoneNo" class="form-control" placeholder="Number.." 
             required value="{{old('user_phoneNo')}}" >
        ...
        <button type="submit" class="btn mt-3 zoomIn" style="background-color:#00d9a5;">Submit Request</button>
      </form>
    </div>
  </div> <!-- .page-section -->
